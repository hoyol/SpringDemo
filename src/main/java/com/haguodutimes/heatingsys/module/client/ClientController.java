package com.haguodutimes.heatingsys.module.client;
...
public class ClientController {
    ...
    @RequestMapping(value = {"/showImportTime"})
    public String showImportTime(Map<String, Object> map) {
        //todo 显示用户信息录入时间
        return "showImportTime";
    }
}
