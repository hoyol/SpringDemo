...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-cog"></i> <span class="nav-label">基础配置</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                              <a class="J_menuItem" href="/testpage">数据字典</a>
                            </li>
                            <li>
                              <a class="J_menuItem" href="suggest.html">菜单管理</a>
                            </li>
                            <li>
                              <a class="J_menuItem" href="/table_basicx">系统全局参数</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/testpages" frameborder="0" data-id="table_basic.html" seamless></iframe>
            </div>
            <div class="footer">
    ...
    <script src="../../bootstrap/js/plugins/layer/layer.min.js"></script>

    <!-- 自定义js -->
    <script src="../../bootstrap/js/hplus.js?v=4.1.0"></script>
    <script type="text/javascript" src="../../bootstrap/js/contabs.js"></script>
